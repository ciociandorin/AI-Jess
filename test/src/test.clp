...
(defrule solutie
    (cripto(litera N)(cifra ?n))
    (cripto(litera I)(cifra ?i &~ ?n))
    (cripto(litera L)(cifra ?l &~ ?i &~ ?n))
    (cripto(litera O)(cifra ?o &~ ?l &~ ?i &~ ?n))
    (cripto(litera V)(cifra ?v &~?o &~ ?l &~ ?i &~ ?n &~0))
    (cripto(litera E)(cifra ?e &~ ?v &~?o &~ ?l &~ ?i &~ ?n))
    (cripto(litera C)(cifra ?c &~?v &~ ?o &~?l &~ ?i &~ ?n &~ ?e &~0))
    ...
    (cripto(litera R)(cifra ?r &~?t &~?c &~?e &~ ?v &~?o &~ ?l &~ ?i &~ ?n))
      ...
      (test
        (eq
            (- 
                (+(* ?n 1)(+(* ?i 10)(+(* ?l 100)(+(* ?o 1000)(+ (* ?i 10000)(* ?v 100000)))))) 
                (+(* ?o 1)(+(* ?l 10)(+(* ?l 100)(+(* ?e 1000)(* ?c 10000)))))) 
